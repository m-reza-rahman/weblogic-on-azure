# WebSphere on Azure
This repository shows how to deploy a Java application to Azure using WebSphere (Traditional) and virtual machines. The repository hosts the demos for this [talk](abstract.md).
